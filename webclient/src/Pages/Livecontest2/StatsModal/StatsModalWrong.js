                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <aside className="col-md-4">
                                           ...
                                           {props.totalquestions != sessionStorage.getItem('questionIndex') ? <><div className="redtitle " ><h2>Next Round Starts In</h2></div>
                                                ...
                                                <div className="redtitle " ><h2>Result Viewing Time</h2></div>
                                 ...
                                 {props.totalquestions != sessionStorage.getItem('questionIndex') && (!props.reentersuccess ?  <a onClick={()=>props.reenter()} className="widget_match_btn">Re-enter  <ImEnter /></a>:<a  className="widget_match_btn">Reentered  <ImEnter /></a>)}
