...
import { Applieduser, Publishedcontest, Liveuser, Question, Admincontest, User, Segment, Ads, aud_contests } from 'src/typeorm';
import { ValidateUserMiddleWare } from 'src/users/middlewares/validate-user.middleware';
import { QuestionController } from './controllers/question/question.controller';
import { QuestionService } from './services/question/question.service';

@Module({
  imports: [TypeOrmModule.forFeature([Question,Admincontest,Publishedcontest,aud_contests,User,Applieduser,Liveuser,Segment,Ads])],
