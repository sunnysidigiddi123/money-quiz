...
import { Applieduser, Auditcontest, Publishedcontest, Liveuser, Question, Admincontest, User, Segment } from 'src/typeorm';
import { ValidateUserMiddleWare } from 'src/users/middlewares/validate-user.middleware';
import { QuestionController } from './controllers/question/question.controller';
import { QuestionService } from './services/question/question.service';

@Module({
  imports: [TypeOrmModule.forFeature([Question,Admincontest,Publishedcontest,Auditcontest,User,Applieduser,Liveuser,Segment])],
