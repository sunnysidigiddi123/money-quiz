  ...
  const reenter = async (e) => {
   ...
   const getQuestions = async (e) => {
      ...
      let sendData = {
         ...
         LivecontestTime:moment(contesttime).add(questions.totalQuestionTime+30, 'seconds')
      ...
      try {
         ...
         setContestTime(moment(contesttime).add(questions.totalQuestionTime+30, 'seconds'))
         if (post.data.question !== null) {
            // setLgShows(true)
            setQuestions(post.data.question)
            setTimerTime(post.data.question.totalQuestionTime+30)
                        ...
                        <span class="text-white position-absolute"> <CountdownCircleTimer
                           ...
                           onComplete={() => {
                              // do your stuff here
                                 ...
                                 return { shouldRepeat: true , isPlaying: true , newInitialRemainingTime:timertime-30}
          ...
          Statistics
           ...
           <Modal.Body className='bb3'>
              ...
              <CountdownCircleTimer
                  ...
                  <StatsModalWrong lgShow={lgShows} setLgShow={setLgShows} reenter={reenter} reentersuccess={reentersuccess} setReentersuccess={setReentersuccess} polldata={polldata} />
                  <StatsModal  lgShow={lgShowss} setLgShow={setLgShowss} cashout={cashout} polldata={polldata} />
