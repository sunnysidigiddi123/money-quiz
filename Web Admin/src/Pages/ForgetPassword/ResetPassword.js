...
import hidePasswordImg from "../ForgetPassword/images/eyesslash.svg";
import showPasswordImg from "../ForgetPassword/images/eyes.svg";
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <img src="vendors/images/resetba.png" alt="" />
            </div>
            <div className="col-md-6">
              {currentPage === 1 && (
